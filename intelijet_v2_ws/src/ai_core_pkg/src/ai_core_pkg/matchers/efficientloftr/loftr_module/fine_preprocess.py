# Vendored from https://github.com/zju3dv/EfficientLoFTR (Apache-2.0).
# Only the inference-time model code is kept - training-only utilities
# (dataloaders, augmentation, distributed-training tricks, experiment
# tracking) from the original repo are not included.
