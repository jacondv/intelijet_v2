...
"")
        ...
        self.txtJobname.setMinimumSize(QtCore.QSize(0, 54))
        self.txtJobname.setMaximumSize(QtCore.QSize(16777215, 61))
        font = QtGui.QFont()
        ...
        self.btnSelect.setMinimumSize(QtCore.QSize(54, 54))
        self.btnSelect.setMaximumSize(QtCore.QSize(54, 54))
        icon = QtGui.QIcon()
        ...
        self.btnEdit.setMinimumSize(QtCore.QSize(54, 54))
        self.btnEdit.setMaximumSize(QtCore.QSize(54, 54))
        icon1 = QtGui.QIcon()
        ...
        self.btnSave.setMinimumSize(QtCore.QSize(54, 54))
        self.btnSave.setMaximumSize(QtCore.QSize(54, 54))
        ...
        self.btnCancel.setMinimumSize(QtCore.QSize(54, 54))
        self.btnCancel.setMaximumSize(QtCore.QSize(54, 54))
        icon2 = QtGui.QIcon()
        ...
        self.btnDelete.setMinimumSize(QtCore.QSize(54, 54))
        self.btnDelete.setMaximumSize(QtCore.QSize(54, 54))
        icon3 = QtGui.QIcon()
