...
" font-size:24px;\n"
"}")
        self.verticalLayout_14 = QtWidgets.QVBoxLayout(setting_page)
        ...
        self.btnSetClosedPosition.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.btnUpdateHousingParam.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.btnCancelHousingParam.setMinimumSize(QtCore.QSize(0, 50))
    ...
    def retranslateUi(self, setting_page):
        ...
        self.label_7.setText(_translate("setting_page", "Open speed (Hz)"))
        self.label_8.setText(_translate("setting_page", "Close speed (Hz)"))
