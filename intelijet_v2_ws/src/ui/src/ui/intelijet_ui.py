...
"")
        ...
        self.tboxPage1.setGeometry(QtCore.QRect(0, 0, 342, 532))
...
"}")
        ...
        self.tboxPage3.setGeometry(QtCore.QRect(0, 0, 342, 532))
        ...
        self.tboxPage2.setGeometry(QtCore.QRect(0, 0, 342, 532))
...
"border-radius:12px;")
        ...
        self.cbbAutoCompare.setCurrentIndex(1)
