...
"")
        ...
        self.btnAsc.setMinimumSize(QtCore.QSize(40, 40))
        self.btnAsc.setMaximumSize(QtCore.QSize(40, 40))
        icon6 = QtGui.QIcon()
        ...
        self.btnDesc.setMinimumSize(QtCore.QSize(40, 40))
        self.btnDesc.setMaximumSize(QtCore.QSize(40, 40))
        icon7 = QtGui.QIcon()
