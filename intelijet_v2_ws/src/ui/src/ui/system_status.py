...
def build_system_status(device_status_dicts, encoder_deg=None, encoder_raw=None):
    ...
    return SystemStatus(devices=devices, encoder_deg=encoder_deg, encoder_raw=encoder_raw)
