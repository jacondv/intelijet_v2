...
class KeypointMatcher:
    ...
    def match_keypoints_by_proximity(self,kp1, des1, kp2, des2, ratio_test=0.75, n_best=2, max_pixel_dist=50):
        ...
        kp1, des1: keypoints và descriptors của ảnh 1
        kp2, des2: keypoints và descriptors của ảnh 2
        ratio_test: Lowe's ratio test
        n_best: chỉ lấy n_best match tốt nhất
        max_pixel_dist: khoảng cách pixel tối đa để xem xét gần nhau
        """
        import cv2
        import numpy as np
