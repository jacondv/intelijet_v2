...
"")
        ...
        self.gridLayout.addWidget(self.label_49, 0, 5, 1, 1)
        self.label_51 = QtWidgets.QLabel(self.groupBox_2)
        self.label_51.setObjectName("label_51")
        self.gridLayout.addWidget(self.label_51, 0, 6, 1, 1)
        self.label_50 = QtWidgets.QLabel(self.groupBox_2)
        self.label_50.setObjectName("label_50")
        self.gridLayout.addWidget(self.label_50, 0, 7, 1, 1)
        self.txtTunnelMinBoundY = QtWidgets.QLineEdit(self.groupBox_2)
        self.txtTunnelMinBoundY.setObjectName("txtTunnelMinBoundY")
        self.gridLayout.addWidget(self.txtTunnelMinBoundY, 1, 6, 1, 1)
        self.txtTunnelMinBoundZ = QtWidgets.QLineEdit(self.groupBox_2)
        self.txtTunnelMinBoundZ.setObjectName("txtTunnelMinBoundZ")
        self.gridLayout.addWidget(self.txtTunnelMinBoundZ, 1, 7, 1, 1)
        self.txtTunnelMinBoundX = QtWidgets.QLineEdit(self.groupBox_2)
        self.txtTunnelMinBoundX.setObjectName("txtTunnelMinBoundX")
        self.gridLayout.addWidget(self.txtTunnelMinBoundX, 1, 5, 1, 1)
        self.txtTunnelMaxBoundZ = QtWidgets.QLineEdit(self.groupBox_2)
        self.txtTunnelMaxBoundZ.setObjectName("txtTunnelMaxBoundZ")
        self.gridLayout.addWidget(self.txtTunnelMaxBoundZ, 2, 7, 1, 1)
        self.txtTunnelMaxBoundY = QtWidgets.QLineEdit(self.groupBox_2)
        self.txtTunnelMaxBoundY.setObjectName("txtTunnelMaxBoundY")
        self.gridLayout.addWidget(self.txtTunnelMaxBoundY, 2, 6, 1, 1)
        self.txtTunnelMaxBoundX = QtWidgets.QLineEdit(self.groupBox_2)
        self.txtTunnelMaxBoundX.setObjectName("txtTunnelMaxBoundX")
        self.gridLayout.addWidget(self.txtTunnelMaxBoundX, 2, 5, 1, 1)
